...
int main() {
  ...
  // start in lane 1 (lane 0 is the leftmost one)
  int lane = 1;
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // Previously we just added 50 waypoints but it was not smooth driving.
            ...
            for (int i=1; i<50-previous_path_x.size(); i++) {
                ...
                double N = target_dist / (0.02*ref_vel/2.24); // divide by 2.24 to convert mph to m/s
                ...
                // Convert back to global reference frame
